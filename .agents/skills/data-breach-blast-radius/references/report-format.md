...
_This report was generated by the [data-breach-blast-radius](https://github.com/github/awesome-copilot/tree/main/skills/data-breach-blast-radius) skill for GitHub Copilot._  
_For risk planning purposes only. Consult qualified legal counsel and security professionals for actual regulatory guidance._
````
