...
const products = [
  ...
  },
  {
    ...
    iconColor: "#64748b",
    image:
      "https://images.unsplash.com/photo-1557800636-894a64c1696f?w=200&h=200&fit=crop",
  },
];
  ...
  return (
    <View className="flex-1 bg-[#050914]">
      ...
      <View className="flex-row items-center justify-between px-6 pt-16 pb-4">
        ...
        <Text className="text-gray-900 text-lg font-semibold">Products</Text>
        ...
        {products.map((product, index) => (
          ...
          >
            ...
            <View className="flex-1 justify-center">
              ...
              <Text className="text-[#94a3b8] text-xs mb-1">
                SKU: {product.sku}
              </Text>
              <View className="flex-row justify-between items-end">
                ...
                <Text className="text-gray-900 font-bold">{product.price}</Text>
              </View>
            </View>
          </View>
        ))}
