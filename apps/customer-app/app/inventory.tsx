...
export default function InventoryScreen() {
  return (
    <View className="flex-1 bg-[#050914]">
      ...
      <View className="px-6 mb-6">
        <ScrollView horizontal showsHorizontalScrollIndicator={false} className="flex-row">
          <View className="bg-[#0e1423] border border-[#1e2942] rounded-xl p-4 mr-3 min-w-[110px]">
            <Text className="text-[#3b82f6] text-xs font-semibold mb-2">Total Products</Text>
            <Text className="text-white text-xl font-bold">982</Text>
          </View>
          <View className="bg-[#0e1423] border border-[#1e2942] rounded-xl p-4 mr-3 min-w-[110px]">
            <Text className="text-[#f97316] text-xs font-semibold mb-2">Low Stock</Text>
          ...
          <View className="bg-[#0e1423] border border-[#1e2942] rounded-xl p-4 mr-6 min-w-[110px]">
            <Text className="text-[#ef4444] text-xs font-semibold mb-2">Out of Stock</Text>
      ...
      {/* Low Stock Products */}
      <ScrollView className="flex-1 px-6 mb-32" showsVerticalScrollIndicator={false}>
        <View className="flex-row justify-between items-center mb-4">
          <Text className="text-white text-base font-semibold">Low Stock Products</Text>
