  ...
  return (
    <View className="flex-1 bg-[#050914]">
      ...
      <View className="flex-row items-center justify-between px-6 pt-16 pb-4">
        ...
        <Text className="text-gray-900 text-lg font-semibold">Reports</Text>
        <Pressable>
      ...
      <View className="px-6 mb-6">
        ...
        >
          <Pressable className="bg-[#FF8C00] px-4 py-2 rounded-lg mr-3">
            <Text className="text-gray-900 font-semibold text-sm">Sales</Text>
          </Pressable>
      ...
      >
        ...
        <View className="bg-[#0e1423] border border-[#1e2942] rounded-2xl p-4 mb-6">
          ...
          <Text className="text-[#e2e8f0] text-xs font-medium mb-1">
            Total Revenue
          </Text>
          ...
          <Text className="text-green-500 text-xs font-medium mb-6">
            ↑ 18.4% <Text className="text-[#64748b]">vs last month</Text>
          </Text>
        ...
        <View className="flex-row justify-between items-center mb-4">
          <Text className="text-gray-900 text-base font-semibold">Summary</Text>
        ...
        <View className="flex-row flex-wrap justify-between">
          <View className="bg-[#0e1423] border border-[#1e2942] w-[48%] rounded-2xl p-4 mb-4">
            <Text className="text-[#94a3b8] text-xs font-medium mb-2">
              Total Orders
            </Text>
            <Text className="text-gray-900 text-xl font-bold mb-1">1,245</Text>
          ...
          <View className="bg-[#0e1423] border border-[#1e2942] w-[48%] rounded-2xl p-4 mb-4">
            ...
            <Text className="text-gray-900 text-xl font-bold mb-1">3,456</Text>
          ...
          <View className="bg-[#0e1423] border border-[#1e2942] w-[48%] rounded-2xl p-4 mb-4">
            ...
            <Text className="text-gray-900 text-xl font-bold mb-1">456</Text>
