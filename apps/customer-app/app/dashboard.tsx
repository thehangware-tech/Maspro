  ...
  return (
    <View className="flex-1 bg-[#050914]">
      ...
      <View className="flex-row items-center justify-between px-6 pt-16 pb-4">
        ...
        <Text className="text-gray-900 text-lg font-semibold">Dashboard</Text>
      ...
      <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row justify-between items-center mb-6">
          ...
          <Pressable className="flex-row items-center bg-[#0e1423] border border-[#1e2942] rounded-lg px-3 py-2">
            <Text className="text-[#e2e8f0] text-xs font-medium mr-2">
              7 May 2025
            </Text>
        ...
        <View className="flex-row flex-wrap justify-between mb-6">
          ...
          <View className="bg-[#0e1423] border border-[#1e2942] w-[48%] rounded-2xl p-4 mb-4">
            ...
            <Text className="text-gray-900 text-2xl font-bold mb-2">1,245</Text>
            <Text className="text-green-500 text-xs font-medium">
              ↑ 12.5% <Text className="text-[#64748b]">vs yesterday</Text>
            </Text>
          </View>
          ...
          <View className="bg-[#0e1423] border border-[#1e2942] w-[48%] rounded-2xl p-4 mb-4">
            ...
            <Text className="text-green-500 text-xs font-medium">
              ↑ 18.4% <Text className="text-[#64748b]">vs yesterday</Text>
            </Text>
          </View>
          ...
          <View className="bg-[#0e1423] border border-[#1e2942] w-[48%] rounded-2xl p-4">
            <View className="flex-row items-center mb-4">
              <View className="bg-blue-500/20 p-2 rounded-lg mr-2">
                <Users color="#38BDF8" size={16} />
              </View>
              <Text className="text-[#94a3b8] text-xs font-medium">
                Customers
              </Text>
            </View>
            <Text className="text-gray-900 text-2xl font-bold mb-2">3,456</Text>
            <Text className="text-green-500 text-xs font-medium">
              ↑ 9.7% <Text className="text-[#64748b]">vs yesterday</Text>
            </Text>
          </View>
          ...
          <View className="bg-[#0e1423] border border-[#1e2942] w-[48%] rounded-2xl p-4">
            ...
            <Text className="text-gray-900 text-2xl font-bold mb-2">982</Text>
            <Text className="text-green-500 text-xs font-medium">
              ↑ 3.1% <Text className="text-[#64748b]">vs yesterday</Text>
            </Text>
          </View>
        </View>
        ...
        <View className="bg-[#0e1423] border border-[#1e2942] rounded-2xl p-4 mb-6">
          ...
          <Text className="text-green-500 text-xs font-medium mb-6">
            ↑ 18.4% <Text className="text-[#64748b]">vs last week</Text>
          </Text>
          ...
          <View className="flex-row h-32 mb-2">
            ...
            <View className="flex-1 justify-end relative">
              ...
              >
                <Path
                  d="M0,80 L10,60 L20,70 L30,75 L40,65 L50,55 L60,65 L70,75 L80,50 L90,60 L100,20 L100,100 L0,100 Z"
                  fill="#FF8C00"
                  fillOpacity="0.1"
                />
                <Path
                  d="M0,80 L10,60 L20,70 L30,75 L40,65 L50,55 L60,65 L70,75 L80,50 L90,60 L100,20"
                  fill="none"
                  stroke="#FF8C00"
                  strokeWidth="2"
                />
        ...
        <View className="bg-[#0e1423] border border-[#1e2942] rounded-2xl p-4 mb-24">
          ...
          <View className="flex-row items-center">
            <Image
              source={{
                uri: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=100&q=80",
              }}
