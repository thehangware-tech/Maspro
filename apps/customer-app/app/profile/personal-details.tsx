      ...
      >
        <TwScrollView className="flex-1" contentContainerClassName="px-6 py-8">
          ...
          <TwView className="mb-5">
            <TwText className="text-gray-500 font-medium mb-2">
              Full Name
            </TwText>
            <TwView className="bg-[#FFFFFF] h-14 rounded-xl px-4 border border-gray-200 justify-center">
              <TwTextInput
          ...
          <TwView className="mb-5">
            ...
            <TwPressable className="bg-[#FFFFFF] h-14 rounded-xl px-4 border border-gray-200 flex-row items-center justify-between">
              <TwText className="text-gray-900 text-base">{dob}</TwText>
              <CalendarIcon />
            </TwPressable>
          </TwView>
          ...
          <TwView className="mb-8">
            <TwText className="text-gray-500 font-medium mb-2">Gender</TwText>
            <TwPressable className="bg-[#FFFFFF] h-14 rounded-xl px-4 border border-gray-200 flex-row items-center justify-between">
              <TwText className="text-gray-900 text-base">{gender}</TwText>
              <ChevronDown />
            </TwPressable>
          </TwView>
        </TwScrollView>
        ...
        {/* Save Button */}
        <TwView className="px-6 pb-6 pt-2 bg-[#F8FAFC]">
          <TwPressable className="bg-[#0EA5E9] w-full h-14 rounded-xl items-center justify-center shadow-lg shadow-[#0EA5E9]/30">
            <TwText className="text-gray-900 font-bold text-lg">
              Save Changes
            </TwText>
          </TwPressable>
