...
const coupons = [
  {
    ...
    dateLabel: "Valid Till: 31 May 2025",
    usage: "Used: 234",
  ...
  },
  {
    ...
    dateLabel: "Valid Till: 15 Jun 2025",
    usage: "Used: 98",
    iconBg: "bg-red-500/10",
    iconColor: "#ef4444",
  },
  {
    code: "SUMMER20",
    desc: "20% OFF up to ₹1000",
    status: "Scheduled",
    statusColor: "text-blue-500",
    statusBg: "bg-blue-500/10",
    minOrder: "Min. Order: ₹2,999",
    dateLabel: "Starts: 20 May 2025",
    usage: "",
  ...
  },
  {
    ...
    dateLabel: "Expired on: 01 May 2025",
    usage: "120",
    iconBg: "bg-[#1e2942]",
    iconColor: "#94a3b8",
  },
  ...
  return (
    <View className="flex-1 bg-[#050914]">
      ...
      <View className="flex-row items-center px-6 pt-16 pb-4">
        ...
        <Text className="text-gray-900 text-lg font-semibold flex-1 text-center pr-8">
          Offers & Coupons
        </Text>
      </View>
      ...
      <View className="px-6 mb-6">
        <View className="flex-row bg-[#0e1423] rounded-xl p-1 border border-[#1e2942]">
          <Pressable className="flex-1 bg-[#FF8C00] rounded-lg py-2.5 items-center">
            <Text className="text-gray-900 font-semibold text-sm">Coupons</Text>
          </Pressable>
          <Pressable className="flex-1 rounded-lg py-2.5 items-center">
            <Text className="text-[#94a3b8] font-semibold text-sm">
              Banners
            </Text>
          </Pressable>
        </View>
      ...
      >
        {coupons.map((coupon, index) => (
          <View
            key={index}
            className="bg-[#0e1423] border border-[#1e2942] rounded-2xl p-4 mb-4"
          >
            <View className="flex-row items-center mb-4">
              <View
                className={`w-12 h-12 rounded-xl items-center justify-center mr-4 ${coupon.iconBg}`}
              >
              ...
              <View className="flex-1">
                <View className="flex-row justify-between items-center mb-1">
                  ...
                  <View className={`px-2 py-1 rounded-md ${coupon.statusBg}`}>
                    <Text
                      className={`text-[10px] font-bold ${coupon.statusColor}`}
                    >
                      {coupon.status}
                    </Text>
                  </View>
            ...
            <View className="flex-row justify-between items-center pt-2">
              <View className="flex-row items-center">
                ...
                <Text className="text-[#64748b] text-[10px] ml-1">
                  {coupon.minOrder}
                </Text>
              </View>
