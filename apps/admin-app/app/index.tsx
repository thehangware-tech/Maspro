...
const MasproLogo = () => (
  <TwView className="items-center justify-center mt-10 mb-4 z-10">
    <TwView className="flex-row items-center justify-center">
      ...
      <TwView>
        <TwText className="text-white font-extrabold text-3xl tracking-widest leading-none">
          SPORTS
        </TwText>
        <TwText className="text-[#FF6B00] font-extrabold text-3xl tracking-widest leading-none mt-1">
          HOLE
        </TwText>
      </TwView>
    </TwView>
    <TwText className="text-gray-400 font-medium text-sm tracking-[0.3em] mt-3">
      A D M I N P A N E L
    </TwText>
  </TwView>
);
        ...
        >
          ...
          <TwView className="px-6 pb-12">
            <TwView className="items-center mb-8 mt-10">
              <TwText className="text-white text-3xl font-bold mb-2">
                Welcome Back! 👋
              </TwText>
            ...
            <TwView className="bg-[#15171E] rounded-2xl h-14 flex-row items-center px-4 border border-[#22252D] mb-4">
              <TwText className="text-white font-medium text-base mr-3">
                +91
              </TwText>
            ...
            <TwView className="flex-row items-center justify-center mb-6">
              ...
              <TwText className="text-gray-500 font-medium text-xs px-4 tracking-widest">
                SIGN IN WITH
              </TwText>
              <TwView className="flex-1 h-[1px] bg-[#22252D]" />
            </TwView>
            ...
            >
              ...
              <TwText className="text-black font-semibold text-base">
