...
const products = [
  { name: 'SS Master 1000 Cricket Bat', sku: 'BAT1000', stock: 25, price: '₹2,999', icon: RefreshCw, iconColor: '#f97316' },
  { name: 'Nike Air Zoom Pegasus 40', sku: 'SHOE2001', stock: 36, price: '₹6,499', icon: ChevronRight, iconColor: '#64748b' },
  { name: 'Nivia Storm Football', sku: 'FB1001', stock: 40, price: '₹1,899', icon: ChevronRight, iconColor: '#64748b' },
  { name: 'Yonex Astrox 99', sku: 'BN1002', stock: 28, price: '₹1,899', icon: ChevronRight, iconColor: '#64748b' },
  { name: 'SG Club Helmet', sku: 'HM5001', stock: 19, price: '₹1,199', icon: ChevronRight, iconColor: '#64748b' },
];
      ...
      <ScrollView className="flex-1 px-6 mb-24" showsVerticalScrollIndicator={false}>
        {products.map((product, index) => (
          <View key={index} className="bg-[#0e1423] border border-[#1e2942] rounded-2xl p-4 flex-row mb-4">
            ...
            <View className="w-16 h-16 bg-[#161f33] rounded-xl mr-4"></View>
