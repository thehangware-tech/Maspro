      ...
      <TwView className="flex-row items-center justify-between">
        <TwView>
          <TwText className="text-white font-bold text-base">
            {stock}{" "}
            <TwText className="text-gray-500 text-xs font-normal">
              in stock
            </TwText>
          </TwText>
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#0A0D14" }}>
      ...
      <TwView className="px-6 pb-4">
        <TwView className="bg-[#7F1D1D] rounded-xl p-3 flex-row items-center">
          ...
          <TwText className="text-red-200 ml-2 text-sm font-medium flex-1">
            12 items are below minimum stock level
          </TwText>
          <TwPressable>
            <TwText className="text-white text-xs font-bold underline">
              View All
            </TwText>
          </TwPressable>
        </TwView>
