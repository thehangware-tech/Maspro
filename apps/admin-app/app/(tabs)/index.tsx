...
const HeaderLogo = () => (
  <TwView className="flex-row items-center justify-center">
    ...
    <TwView>
      <TwText className="text-white font-extrabold text-[16px] tracking-widest leading-none">
        MASPRO
      </TwText>
      <TwText className="text-[#FF6B00] font-extrabold text-[8px] tracking-widest leading-none mt-0.5">
        SPORTS INDIA
      </TwText>
    </TwView>
  </TwView>
...
const StatCard = ({
  ...
  <TwPressable
    onPress={onPress}
    className="bg-[#15171E] rounded-2xl p-4 flex-1 border border-[#22252D]"
  >
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#0A0D14" }}>
      ...
      >
        ...
        <TwView className="flex-row justify-between items-start mb-6">
          <TwView>
            <TwText className="text-white text-xl font-bold mb-1">
              Hello, Admin 👋
            </TwText>
            <TwText className="text-gray-400 text-sm">
        ...
        <TwView className="mb-8">
          ...
          <TwView className="mb-6">
            <TwText className="text-white text-2xl font-bold mb-1">
              ₹12,45,000
            </TwText>
            <TwView className="flex-row items-center">
              <TwText className="text-green-500 text-xs font-medium">
                ▲ 18.4%
              </TwText>
              <TwText className="text-gray-500 text-xs ml-2">
                vs last week
              </TwText>
            </TwView>
          </TwView>
        ...
        <TwView className="mb-4">
          <TwView className="flex-row justify-between items-center mb-4">
            ...
            <TwPressable onPress={() => router.push("/(tabs)/products")}>
              <TwText className="text-[#FF6B00] text-xs font-medium">
                View All
              </TwText>
            </TwPressable>
          </TwView>
          ...
          <TwView className="bg-[#15171E] rounded-2xl p-4 flex-row items-center border border-[#22252D]">
            ...
            <TwView className="flex-1">
              <TwText className="text-white font-bold text-base mb-1">
                Nike Air Zoom Pegasus 40
              </TwText>
              <TwText className="text-[#FF6B00] font-medium text-xs">
                261 Sold
              </TwText>
            </TwView>
          </TwView>
