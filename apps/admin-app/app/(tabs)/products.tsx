...
import { Menu, Filter, Search, ChevronRight, Plus, Bell } from 'lucide-react-native';
import { View as TwView, Text as TwText, Pressable as TwPressable } from '../../src/tw';
import { useRouter } from 'expo-router';

const ProductItem = ({ image, title, sku, stock, price, status, statusColor }: any) => {
    ...
    >
      ...
      <TwView className="flex-1 justify-center">
        ...
        <TwView className="flex-row items-start justify-between">
          ...
          <TwText className={`text-xs font-medium mt-1`} style={{ color: statusColor }}>{status}</TwText>
        </TwView>
      </TwView>
    </TwPressable>
  );
...
export default function ProductsScreen() {
  ...
  const mockProducts = [
    { id: '1', title: 'SS Master 1000 Cricket Bat', sku: 'BAT1000', stock: 25, price: '₹2,999', status: 'In Stock', statusColor: '#10B981', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=150' },
    { id: '2', title: 'Nike Air Zoom Pegasus 40', sku: 'SHOE2001', stock: 36, price: '₹6,499', status: 'In Stock', statusColor: '#10B981', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=150' },
    { id: '3', title: 'Nivia Storm Football', sku: 'FB1001', stock: 40, price: '₹1,899', status: 'In Stock', statusColor: '#10B981', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=150' },
    { id: '4', title: 'Yonex Astrox 99', sku: 'BN1002', stock: 28, price: '₹1,899', status: 'In Stock', statusColor: '#10B981', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=150' },
    { id: '5', title: 'SG Club Helmet', sku: 'HM5001', stock: 10, price: '₹1,199', status: 'In Stock', statusColor: '#10B981', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=150' },
  ];
        ...
        <TwView className="mb-2 border-b border-[#22252D]">
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {tabs.map((tab) => (
              ...
              >
                <TwText 
                  className={activeTab === tab.name ? "text-[#FF6B00] font-bold text-sm" : "text-gray-500 font-medium text-sm"}
                >
