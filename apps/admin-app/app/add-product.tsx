  ...
  return (
    <View className="flex-1 bg-[#050914]">
      ...
      <View className="flex-row items-center px-6 pt-16 pb-4">
        ...
        <Text className="text-white text-lg font-semibold flex-1">Add Product</Text>
      </View>
      ...
      <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="mb-6">
          <ScrollView horizontal showsHorizontalScrollIndicator={false} className="flex-row py-2">
            ...
            <Pressable className="w-20 h-24 rounded-xl border border-dashed border-[#64748b] items-center justify-center bg-[#050914] mr-6">
              ...
              <Text className="text-[#e2e8f0] text-[10px] font-medium">Add Images</Text>
            </Pressable>
          </ScrollView>
        </View>
        ...
        <View className="mb-6">
          ...
          <View className="flex-row justify-between mb-4">
            <View className="w-[48%]">
              <Text className="text-white text-sm font-medium mb-2">Brand</Text>
            ...
            <View className="w-[48%]">
              <Text className="text-white text-sm font-medium mb-2">SKU</Text>
              <View className="bg-[#0e1423] border border-[#1e2942] rounded-xl h-12 px-4 justify-center">
                <TextInput 
                  className="text-white text-sm"
          ...
          <View className="flex-row justify-between mb-4">
            <View className="w-[48%]">
              <Text className="text-white text-sm font-medium mb-2">Retail Price (₹)</Text>
              <View className="bg-[#0e1423] border border-[#1e2942] rounded-xl h-12 px-4 justify-center">
                <TextInput 
                  className="text-white text-sm"
                  placeholder="0.00"
            ...
            <View className="w-[48%]">
              <Text className="text-white text-sm font-medium mb-2">Wholesale Price (₹)</Text>
              <View className="bg-[#0e1423] border border-[#1e2942] rounded-xl h-12 px-4 justify-center">
                <TextInput 
                  className="text-white text-sm"
                  placeholder="0.00"
          ...
          <View className="flex-row justify-between mb-24">
            <View className="w-[48%]">
              <Text className="text-white text-sm font-medium mb-2">Stock Quantity</Text>
              <View className="bg-[#0e1423] border border-[#1e2942] rounded-xl h-12 px-4 justify-center">
                <TextInput 
                  className="text-white text-sm"
                  placeholder="0"
            ...
            <View className="w-[48%]">
              <Text className="text-white text-sm font-medium mb-2">Minimum Wholesale Qty</Text>
              <View className="bg-[#0e1423] border border-[#1e2942] rounded-xl h-12 px-4 justify-center">
                <TextInput 
                  className="text-white text-sm"
                  placeholder="0"
